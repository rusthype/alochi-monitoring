      ...
      child: Column(children: [
        ...
        if (_expanded) ...[
          ...
          ...widget.wrongAnswers.asMap().entries.map((e) {
            ...
            final sAns  = _answerLabel[w['student_answer']] ?? w['student_answer'];
            final cAns  = _answerLabel[w['correct_answer']] ?? w['correct_answer'];
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(children: [
                  Container(
                    ...
                    child: Text('$pos', style: const TextStyle(
                        fontSize: 11, fontWeight: FontWeight.w700,
                        color: AppColors.ink2, fontFamily: 'JetBrainsMono')),
                  ),
                  const SizedBox(width: 8),
                  Text(subj, style: const TextStyle(fontSize: 11, color: AppColors.ink3,
                ...
                if (imgUrl != null) ...[
                  ...
                  ClipRRect(
                    borderRadius: BorderRadius.circular(8),
                    child: Image.network(imgUrl, height: 80, fit: BoxFit.contain,
