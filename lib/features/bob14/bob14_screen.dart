        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border:
                  Border.all(color: AppColors.emerald.withValues(alpha: .25)),
            ),
            child: Row(children: [
              ...
              Expanded(
                  child: Column(
                      ...
                      children: [
                    Text(AppLocalizations.of(context)!.bob14ScreenTitle,
                        style: const TextStyle(
                            fontWeight: FontWeight.w800,
                            fontSize: 13,
                            color: AppColors.emeraldInk)),
                    const SizedBox(height: 2),
                    Text(AppLocalizations.of(context)!.bob14TestInfo,
                        style: const TextStyle(
            ...
            children: List.generate(15, (i) {
              ...
              return GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: sel ? AppColors.emerald : AppColors.surface,
                    borderRadius: BorderRadius.circular(10),
                    border: Border.all(
                        color: sel ? AppColors.emerald : AppColors.border,
                        width: sel ? 2 : 1.5),
                    boxShadow: sel
                        ? [
                            BoxShadow(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Text(
          variant != null
              ? 'V$variant'
              : AppLocalizations.of(context)!.bob14FallbackLabel,
          style: const TextStyle(
              fontSize: 12,
              fontWeight: FontWeight.w700,
              color: AppColors.emeraldInk)),
