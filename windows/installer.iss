...
[Run]
Filename: "{tmp}\vc_redist.x64.exe"; Parameters: "/install /quiet /norestart"; StatusMsg: "Microsoft Visual C++ Runtime o'rnatilmoqda..."; Check: VCRedistNeedsInstall; Flags: waituntilterminated
